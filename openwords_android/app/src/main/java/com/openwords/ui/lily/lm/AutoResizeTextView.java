...
/**
 * a textView that is able to self-adjust its font size depending on the min and
 * max size of the font, and its own size.<br/>
 ...
 * <br/>
 * It should work fine with most Android versions, but might have some issues on
 * Android 3.1 - 4.04, as setTextSize will only work for the first time. <br/>
 * More info here: https://code.google.com/p/android/issues/detail?id=22493 and
 * here in case you wish to fix it: http://stackoverflow.com/a/21851239/878126
 */
    ...
    public AutoResizeTextView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        _sizeTester = new SizeTester() {
            ...
            public int onTestSize(final int suggestedSize, final RectF availableSPace) {
                ...
                if (availableSPace.contains(textRect)) // may be too small, don't worry we will find the best match
                {
                    return -1;
                }
                // else, too big
