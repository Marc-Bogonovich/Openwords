...
require_once('templates/class/dao/sql/Connection2.class.php');
require_once('templates/class/dao/sql/ConnectionFactory2.class.php');
require_once('templates/class/dao/sql/ConnectionProperty2.class.php');
require_once('templates/class/dao/sql/QueryExecutor2.class.php');
require_once('templates/class/dao/sql/Transaction2.class.php');
require_once('templates/class/dao/sql/SqlQuery2.class.php');
require_once('templates/class/Template.php');

function generate(){
	init();
	$sql = 'SHOW TABLES';
	$ret = QueryExecutor2::execute(new SqlQuery2($sql));
...
function init(){
	...
	copy('templates/class/dao/sql/Connection2.class.php', 'generated/class/sql/Connection2.class.php');
	copy('templates/class/dao/sql/ConnectionFactory2.class.php', 'generated/class/sql/ConnectionFactory2.class.php');
	copy('templates/class/dao/sql/ConnectionProperty2.class.php', 'generated/class/sql/ConnectionProperty2.class.php');
	copy('templates/class/dao/sql/QueryExecutor2.class.php', 'generated/class/sql/QueryExecutor2.class.php');
	copy('templates/class/dao/sql/Transaction2.class.php', 'generated/class/sql/Transaction2.class.php');
	copy('templates/class/dao/sql/SqlQuery2.class.php', 'generated/class/sql/SqlQuery2.class.php');
	copy('templates/class/dao/core/ArrayList2.class.php', 'generated/class/core/ArrayList2.class.php');
}
...
function createDAOFactory($ret){
	...
	$template->write('generated/class/dao/DAOFactory2.class.php');
}
...
function getFields($table){
	$sql = 'DESC '.$table;
	return QueryExecutor2::execute(new SqlQuery2($sql));
}
