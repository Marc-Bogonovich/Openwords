//This program is to get english_chinese data
...
public class Openwords_data {
  ...
  public static void main(String[] args) throws XMLStreamException, Exception {
      ...
      Pattern outter = Pattern.compile("\\{t\\+??\\|cmn\\|([^\\{]*?)\\}");
              ...
              case XMLStreamConstants.CHARACTERS:
                  ...
                  if(isWord && inPage == true && inNs == false && inTitle == false && inText == true) {
                      ...
                      if(textLine < 2) {          
                          ...
                          if(reader.getText().trim().contains("*: Mandarin:")) {                                   
                              ...
                              while (matcher_outter.find()) {     
                                  ...
                                  if(text_tmp.contains("tr=")) {
                                      if(text_tmp.contains("alt=")) {
                                          matcher_inner3 = inner3.matcher(text_tmp);
                                          if(matcher_inner3.find()) {
                                              word = matcher_inner3.group(1);          
                                          }                                
                                      }                              
                                      else {
                                          ni = 0;                       
                                      ...
                                      if(matcher_inner2.find()) {                   
                                          pinyin = matcher_inner2.group(1);
                                      } 
                                      entity.put(word, pinyin);
                                  }  
                                  else {
                                      ni = 0;                       
                                      matcher_inner1 = inner1.matcher(text_tmp);
