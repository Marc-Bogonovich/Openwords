...
public class MySQLAccess { 
    ...
    public void writeDatabase(int id,//I think we may not need the "id" value here as the auto_id should be generated by the database so that we don't have to worry about it. 
