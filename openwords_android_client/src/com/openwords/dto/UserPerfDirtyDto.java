...
public class UserPerfDirtyDto {
	...
	public UserPerfDirtyDto(int user_id, int connection_id, int total_correct, int total_skipped,int total_exposure, int last_time, int last_performance, int user_exclude)
	{
