...
public class UserWords extends SugarRecord<UserWords> {
	...
	public static List<UserWords> findFresh(int languageID)
	{
		List<UserWords> uw = UserWords.find(UserWords.class, "fresh='1' and l_two_id="+languageID);
		return uw;
	}
	
	public static List<UserWords> findFreshWithAudio(int languageID)
	{
		List<UserWords> uw = UserWords.find(UserWords.class, "fresh='1' and audiocall<>'null' and l_two_id="+languageID);
		return uw;
	}
