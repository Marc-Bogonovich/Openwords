...
public class FragmentReview extends FragmentLearningModule {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final ViewMaxText pinyin = (ViewMaxText) myFragmentView.findViewById(R.id.frag_review_text1);
        pinyin.config(Color.parseColor("#ff00ff"), 255, transcription, 48, null);

        final ViewMaxText word = (ViewMaxText) myFragmentView.findViewById(R.id.frag_review_text2);
        word.config(Color.parseColor("#ff00ff"), 255, w1, 128, null);//我的老板真的是特别的胖，啊哈哈哈哈哈哈哈哈哈哈哈哈。

        final ViewMaxText translation = (ViewMaxText) myFragmentView.findViewById(R.id.frag_review_text3);
